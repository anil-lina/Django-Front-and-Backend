...
//    var vacc = prompt ("Are you on vacation (true or false only)")
//
//    if (weekday === "sunday" || weekday === "saturday"){
//    var w = "true"
//    }
//    else {w = "false"}
//    if (w === "true" && vacc === "true")(r = "true")
//    else if (w === "false" && vacc === "true")(r = "true")
//    else r = "false"
//    return r
//
//}
...
//    //Code Goes Here
//     var aSmile = prompt("Monkey A smile status (true or false) : ")
//    var bSmile = prompt("Monkey B smile status (true or false) : ")
//    if (aSmile === bSmile) { var r =  "we are in trouble"}
//    else {r = "we are good"}
//    return r
//};
...
//    //Code Goes Here
//    var str = "Hi"
//    var n = prompt("enter the times to be printed : ")
//    w = str.repeat(n)
//    return w
//} ;
...
//n3 = parseInt(z)
//if (n1 === 13){var sum=0}
//else if (n2 === 13){sum = n1}
//else if (n3===13){sum = n1+n2}
//else (sum = n1+n2+n3)
//return sum
...
//  var bday = prompt("is it your birthday (true\false)")
//  if (bday === "false" ){
//  if (speed >= 61 && speed <= 80 ){ var tic = 1 }
//  else if (speed > 81 ){ var tic = 2 }
//  }
//  else{ tic = 0}
//return tic
//}
...
//  //Code Goes Here
//  if (small*1 + big*5 >= goal){var ach = true}
//  else {var ach = false }
//  return ach
//}
